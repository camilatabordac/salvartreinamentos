      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <h2 className="text-3xl font-semibold">
            Treinamento em sala de emergência realista
          </h2>

          <p className="text-white/70 mt-4 leading-relaxed">
            Você treina cenários críticos hospitalares com simulação real,
            desenvolvendo organização, agilidade e tomada de decisão rápida.
          </p>

          <p className="text-primary mt-4">
            Aqui você atua como se estivesse dentro de uma emergência real.
          </p>
        </div>
        ...
        <section className="px-6 lg:px-12 py-20 bg-gradient-to-br from-black via-zinc-900 to-black">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-semibold mt-4 leading-tight">
              Emergência{" "}
              <span className="text-primary">Hospitalar</span>
            </h1>

            <p className="text-white/70 mt-6 max-w-2xl mx-auto leading-relaxed">
              Treinamento intensivo voltado ao manejo do paciente crítico em ambiente hospitalar,
              com foco em organização, agilidade e eficiência no atendimento.
            </p>
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur hover:bg-white/10 transition">
              <h3 className="text-lg font-semibold mb-3 flex items-center gap-2">
                <Activity className="text-primary" /> O que é Sala Vermelha
              </h3>

              <p className="text-white/70 leading-relaxed">
                A Sala Vermelha é o setor hospitalar destinado ao atendimento de pacientes graves.
              </p>
            </div>
        ...
        <section className="px-6 lg:px-12 py-20 bg-gradient-to-r from-primary/10 to-transparent text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-white/70 mt-4">
              Treine para agir com precisão em situações críticas hospitalares.
            </p>
